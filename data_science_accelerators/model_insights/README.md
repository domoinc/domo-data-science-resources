...
5. Also in your running Jupyter workspace, open a new terminal window by selecting **File > New > Terminal**. Type the following code in the terminal window and hit **Enter**: ```tar xf model_insights.tar``` (note: do not copy and paste the code from here or you will get an error). This will enable use of examples and all source files for the model insights tool.
